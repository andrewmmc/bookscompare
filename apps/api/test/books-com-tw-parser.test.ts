...
test('parseBooksComTwSearchResults returns one normalized offer for found fixture', async () => {
  ...
  assert.deepEqual(offers[0], {
    ...
    summary: '現代女目連救母，唐卡畫般眩目燦麗…… 鍾文音寫作生涯的重要轉折點， 活色生香又凌厲殘酷的最新長篇鉅著—— 死與生、空與色，人之大欲所在。 榮獲2021年台灣文學獎‧金典獎‧年度大獎 國藝會長篇小說專案...',
    price: 537,
    currency: 'TWD',
    ...
    imageUrl: 'https://im1.book.com.tw/image/getImage?i=https://www.books.com.tw/img/001/104/99/0011049950.jpg&w=187&h=187&v=69e9a24b',
    badges: [],
  })
  assert.deepEqual(offers[1], {
    ...
    imageUrl: 'https://im1.book.com.tw/image/getImage?i=https://www.books.com.tw/img/E05/032/94/E050329458.jpg&w=187&h=187&v=69e79c89',
    previewUrl: 'https://search.books.com.tw/redirect/move/key/9786264560092/area/mid_epub/item/E050329458/page/1/epub/1/idx/2/cat/E05/pdf/0/spell/3',
    badges: [],
  })
})
